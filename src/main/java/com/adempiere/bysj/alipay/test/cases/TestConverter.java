package com.adempiere.bysj.alipay.test.cases;

import com.adempiere.bysj.alipay.test.Util;
import com.adempiere.bysj.alipay.test.response.TestResponse;
    ...
    public static void main(String[] args) throws AlipayApiException, ClassNotFoundException {
        for (int i = 2; i <= 2; i++) {
            ...
            TestResponse resultOldXml = null;
            {
                ...
                resultNewJson = converter.toResponse(caseString, TestResponse.class);
                System.out.println("\n" + resultNewJson);
            }
            {
                ...
                JsonConverter converter = new JsonConverter();
                resultOldJson = converter.toResponse(caseString, TestResponse.class);
                System.out.println("\n" + resultOldJson);
            }
            {
                ...
                resultOldXml = converter.toResponse(caseString, TestResponse.class);
                System.out.println("\n" + resultOldXml);
            }
